                    ...
                    <div class="single-sidebar">
                        ...
                        @foreach($additionalProducts as $additionalProduct)
                            <div class="thubmnail-recent">
                                ...
                                <h2>
                                    <a href="{{ route('shop.show', $additionalProduct->slug) }}">{{ $additionalProduct->name }}</a>
                                </h2>
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul>
                            @foreach($recentProducts as $recentProduct)
                                <li>
                                    <a href="{{ route('shop.show', $recentProduct->slug) }}">{{ $recentProduct->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                        ...
                        <div class="woocommerce">
                            <form method="post" action="#">
                                <table cellspacing="0" class="shop_table cart">
                                    ...
                                    @if(Cart::Count() > 0)
                                        <tr class="cart_item">
                                            <h1>{{ Cart::Count() }} Product you added</h1>
                                ...
                                <div class="cross-sells">
                                    ...
                                    <ul class="products">
                                        ...
                                        @foreach($migthAlsoLike as $like)
                                            <li class="product">
                                                <a href="{{ route('shop.show', $like->slug) }}">
                                                    <img width="325" height="325" alt="T_4_front"
                                                         class="attachment-shop_catalog wp-post-image"
                                                         src="img/product-2.jpg">
                                                    <h3>{{ $like->name }}</h3>
                                                    <span class="price"><span class="amount">${{ $like->price }}</span></span>
                                                </a>
